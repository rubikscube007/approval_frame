...
# Django settings for approval_frame project.
...
# Keep your SECRET_KEY secret, and out of GitHub, by generating one for you
# if you don't have one already, in a file that we .gitignore
